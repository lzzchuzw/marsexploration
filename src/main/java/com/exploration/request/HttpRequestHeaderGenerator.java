...
import com.exploration.utils.string.UrlParseUtils;
...
public class HttpRequestHeaderGenerator {
	...
	//User-Agent Header
	//public static final String USER_AGENT_HEADER = "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36";
        //public static final String USER_AGENT_HEADER = "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36";
	//public static final String USER_AGENT_HEADER = "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.24 Safari/537.36";
	public static final String USER_AGENT_HEADER = "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.129 Safari/537.36";    
        /**
	 * 设置访问京东登录主页的Headers
	 * 
	 * @param builder
	 ...
	 * @param builder
	 */
	public static void setCheckSlideAuthCodeHeaders(final RequestBuilder builder) {
		if (null != builder) {
			builder.setHeader("Accept", "text/plain, */*; q=0.01");
			builder.setHeader("Accept-Encoding", "gzip, deflate, br");
			builder.setHeader("Accept-Language", "zh-CN,zh;q=0.9");
			builder.setHeader("Connection", "keep-alive");
			builder.setHeader("Origin", "https://passport.jd.com");
			builder.setHeader("Host", "passport.jd.com");
			builder.setHeader("Referer", "https://passport.jd.com/new/login.aspx");
			//builder.setHeader("Upgrade-Insecure-Requests", "1");	
	 ...
	 * 设置获取京东登录二维码的Header
	 */
	public static void setFetchJDLoginQrCodImgHeaders(final RequestBuilder builder,String url) {
	 ...
	 * 设置京东二维码扫码登录的Headers
	 */
	public static void setCheckQrcodeHeaders(final RequestBuilder builder) {
		if (null != builder) {
			...
			//builder.setHeader("Cache-Control", "no-cache");
			builder.setHeader("Connection", "keep-alive");
			builder.setHeader("Host", "qr.m.jd.com");
			builder.setHeader("Referer", "https://passport.jd.com/new/login.aspx");
			builder.setHeader("Pragma", "no-cache");			
			builder.setHeader("User-Agent",
					USER_AGENT_HEADER);
	...
	/**
	 * 
	 * 设置验证京东二维码扫码后的ticket的Headers
	 */
	public static void setValidateQrCodeTicketHeaders(final RequestBuilder builder) {
		if (null != builder) {
	...
	/**
	 * 获取京东扫码登录成功后的跳转需要的Headers
	 * 
	 * @param builder
	 */
	public static void setLoginSuccessRedirectAfterValidateQrCodeHeaders(final RequestBuilder builder) {
		if (null != builder) {
			builder.setHeader("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8");
			builder.setHeader("Accept-Encoding", "gzip, deflate, br");
			builder.setHeader("Accept-Language", "zh-CN,zh;q=0.9");
			builder.setHeader("Connection", "keep-alive");
			builder.setHeader("Referer", "https://passport.jd.com/new/login.aspx");
			builder.setHeader("Host", "www.jd.com");
			builder.setHeader("Upgrade-Insecure-Requests", "1");			
			builder.setHeader("User-Agent",
					USER_AGENT_HEADER);
		}
	...
	public static void setloginSuccessRedirectLocationHeaders(final RequestBuilder builder) {
		if (null != builder) {
			builder.setHeader(":authority", "www.jd.com");
			builder.setHeader(":method", "GET");
	...
	public static void setFetchPrecontractShoppingRushUrlHeaders(final RequestBuilder builder,String id) {
		if (null != builder) {
			...
			builder.setHeader("Host", "yushou.jd.com");
			builder.setHeader("Referer", "https://item.jd.com/"+id+".html");
			builder.setHeader("Sec-Fetch-Dest", "document");
			builder.setHeader("Sec-Fetch-Mode", "navigate");
			builder.setHeader("Sec-Fetch-Site", "none");
			builder.setHeader("Sec-Fetch-User", "?1");
			builder.setHeader("Upgrade-Insecure-Requests", "1");
			builder.setHeader("User-Agent",
					USER_AGENT_HEADER);
		}
	...
	* @date 2018年8月24日上午9:25:02
     ...
     * @param builder 
     */
	public static void setfetchOrderListHeaders(final RequestBuilder builder) {
		if (null != builder) {
			builder.setHeader("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8");
			builder.setHeader("Accept-Encoding", "gzip, deflate, br");
			builder.setHeader("Accept-Language", "zh-CN,zh;q=0.9");
			builder.setHeader("Cache-Control", "max-age=0");
			builder.setHeader("Connection", "keep-alive");
			builder.setHeader("Host", "order.jd.com");
			builder.setHeader("Referer", "https://www.jd.com/");
			builder.setHeader("Upgrade-Insecure-Requests", "1");
			builder.setHeader("User-Agent",
					USER_AGENT_HEADER);
